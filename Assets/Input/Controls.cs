...
namespace Rootlesnake.Input
{
    ...
    ""controlSchemes"": [
        ...
        private List<IRootActions> m_RootActionsCallbackInterfaces = new List<IRootActions>();
        ...
        public struct RootActions
        {
            ...
            public void AddCallbacks(IRootActions instance)
            {
                if (instance == null || m_Wrapper.m_RootActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_RootActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IRootActions instance)
            {
                @Move.started -= instance.OnMove;
                @Move.performed -= instance.OnMove;
                @Move.canceled -= instance.OnMove;
            ...
            public void RemoveCallbacks(IRootActions instance)
            {
                if (m_Wrapper.m_RootActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IRootActions instance)
            {
                foreach (var item in m_Wrapper.m_RootActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_RootActionsCallbackInterfaces.Clear();
